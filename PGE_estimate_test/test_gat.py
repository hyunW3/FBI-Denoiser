from core.Test_NoiseEstimation import Test_NoiseEstimation
...
if __name__ == '__main__':
    ...
    args.PGE_ON = True
    if args.PGE_ON is True:
        save_file_name += 'with_PGE_net'
    print ('save_file_name : ', save_file_name)
    
    # os.chdir("./PGE_estimate_test")

    output_folder = 'PGE_estimate_test/output_log'
    ...
    args.param_dir = "./PGE_estimate_test/noiseEstimationSET1_val.csv"
    # Initialize model and train
    noise_estimator = Test_NoiseEstimation(_te_data_dir=te_data_dir, _pge_weight_dir = pge_weight_dir, _save_file_name = save_file_name,  _args = args)
