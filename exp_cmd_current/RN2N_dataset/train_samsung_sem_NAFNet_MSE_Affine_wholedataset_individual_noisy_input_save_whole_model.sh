...
CUDA_VISIBLE_DEVICES=$GPU_NUM python main_RN2N.py --nepochs 30 \
    ...
    --alpha $ALPHA --beta $BETA --batch-size $BATCH_SIZE --lr 0.0001 --num-layers 17 \
    --num-filters 64 --crop-size 256 \
    --load-ckpt ./weights/230727_NAFNet_Grayscale_Samsung_SET050607080910_x_as_F01_y_as_F02_MSE_Affine_30.w
