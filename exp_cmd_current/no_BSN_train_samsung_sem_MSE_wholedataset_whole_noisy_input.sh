...
# noise estimation
echo $DATE
echo "=== Train FBI with MSE & No BSN=== integrated SET individual noisy input " $X_F_NUM"<->"$Y_F_NUM"==="
CUDA_VISIBLE_DEVICES=$GPU_NUM python main.py --nepochs 30 --test --log_off\
