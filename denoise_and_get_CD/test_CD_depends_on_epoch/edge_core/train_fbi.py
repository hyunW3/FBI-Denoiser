...
from core.utils import TedataLoader, TrdataLoader, get_PSNR, get_SSIM, inverse_gat, gat, normalize_after_gat_torch
...
class Train_edge_preserving_model(object):
    def __init__(self,_tr_data_dir=None, _te_data_dir=None, _save_file_name = None, _args = None):
        ...
        if self.args.loss_function== 'MSE': # upper bound 1-1(optional)
            ...
            num_output_channel = 2
            self.args.output_type = "linear"
        self.model = Generator(dim=1, ngf_factor=3, depth=4)
