...
pge_net_weight_file=" "
echo "=== N2V Train FBI==="
CUDA_VISIBLE_DEVICES=$GPU_NUM python main.py --use-other-target --x-f-num $X_F_NUM --y-f-num $Y_F_NUM \
	--nepochs 30 --date $DATE --seed 0 --noise-type 'Poisson-Gaussian' --loss-function 'N2V' \
