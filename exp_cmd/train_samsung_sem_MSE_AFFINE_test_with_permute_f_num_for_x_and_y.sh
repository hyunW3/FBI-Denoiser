...
# 지금(221228) 돌아가는 것 : F1~F32 vs F64
./train_samsung_sem_MSE_AFFINE_permute_f_num_for_x_and_y.sh 7 F1 F64 0 &
./train_samsung_sem_MSE_AFFINE_permute_f_num_for_x_and_y.sh 7 F2 F64 1 &
./train_samsung_sem_MSE_AFFINE_permute_f_num_for_x_and_y.sh 7 F4 F64 2 &
./train_samsung_sem_MSE_AFFINE_permute_f_num_for_x_and_y.sh 7 F8 F64 3 &
./train_samsung_sem_MSE_AFFINE_permute_f_num_for_x_and_y.sh 7 F16 F64 0 &
./train_samsung_sem_MSE_AFFINE_permute_f_num_for_x_and_y.sh 7 F32 F64 1 
